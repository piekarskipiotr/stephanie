...
import 'package:stephanie/screens/conceal_form/ui/conceal_info_dialog.dart';
...
class ConcealForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocListener<ConcealFormCubit, ConcealFormState>(
      listener: (context, state) {
        if (state is ConcealingFailed) {
                    ...
                    children: [
                      ...
                      BlocBuilder<ConcealFormCubit, ConcealFormState>(
                        ...
                        return LongerOutlinedButton(
                          ...
                          onClick: state is Concealing
                              ? null
                              : () => AppBottomDialogHelper.show(
                                    context,
                                    BlocProvider.value(
                              ...
                              children: [
                                ...
                                isImage
                                    ? ConstrainedBox(
                                        ...
                                        child:
                                            Image.file(File(state.secretPath)),
                                      )
                                    : Container(
                                        height: 164.0,
                                        width: 164.0,
